      ...
      <aside className="w-64 bg-fintech-900 text-white flex flex-col shadow-xl z-10">
        <div className="p-6 border-b border-fintech-800">
          <div className="flex items-center gap-3">
            <div className="w-8 h-8 bg-fintech-600 rounded flex items-center justify-center font-bold">
              P
            </div>
            ...
            return (
              <Link
                ...
                className={`block px-4 py-3 rounded-lg transition-colors ${
                  isActive
                    ? "bg-fintech-600 text-white font-medium"
        ...
        <div className="p-4 border-t border-fintech-800 text-xs text-slate-400 text-center">
